...
\begin{align*}
  ...
  (1)\quad S  &\;\longrightarrow\; E \\
  (2)\quad E  &\;\longrightarrow\; E \;+\; T \\
  (3)\quad E  &\;\longrightarrow\; T \\
  (4)\quad T  &\;\longrightarrow\; \texttt{(}\; E \;\texttt{)} \\
  (5)\quad T  &\;\longrightarrow\; \texttt{id}
\end{align*}

\noindent The terminal symbols are:
$\{\,\texttt{id},\;+,\;\texttt{(},\;\texttt{)},\;\$\,\}$.
The non-terminals are $\{S', S, E, T\}$.
...
\begin{parts}
  ...
  \textit{Hint: The automaton has approximately 9--10 states.}
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c|c}
    ...
    \multicolumn{5}{c|}{\textbf{ACTION}} &
    \multicolumn{3}{c}{\textbf{GOTO}} \\
    \cmidrule{2-9}
     & \texttt{id} & $+$ & \texttt{(} & \texttt{)} & \$ & $S$ & $E$ & $T$ \\
    \midrule
    0  & & & & & & & & \\
    1  & & & & & & & & \\
    2  & & & & & & & & \\
